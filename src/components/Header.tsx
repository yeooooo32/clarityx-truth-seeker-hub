  ...
  return <header className="absolute top-0 left-0 right-0 py-4 px-6 md:px-10 z-10">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <Link to="/" className="flex items-center gap-2">
          <span className="text-xl font-extralight text-zinc-500">ClarityX</span>
        </Link>
        
        <div className="flex items-center gap-4">
          <Button variant="ghost" className="text-white hover:bg-white/10" onClick={() => scrollToSection('pricing')}>
            Pricing
          </Button>
          <DropdownMenu>
